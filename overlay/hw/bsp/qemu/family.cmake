...
function(family_configure_example TARGET RTOS)
  ...
  # Common sources for all QEMU boards
  ...
  # Select USB drivers based on board name
  # Device board: uses virtual DCD over PL011 UART
  # Host board: uses real DWC2 DCD+HCD against QEMU's emulated controller
  if (BOARD STREQUAL "qemu_raspi0_device")
    target_sources(${TARGET} PUBLIC
      ${TOP}/src/portable/virtual/dcd_vusb.c
      )
  else()
    target_sources(${TARGET} PUBLIC
  ...
  # Flashing: QEMU loads the ELF directly via -kernel
